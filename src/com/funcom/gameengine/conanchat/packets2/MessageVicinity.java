...
/*    */   
/*    */   public MessageVicinity() {}
/*    */   
/*    */   public MessageVicinity(Integer32 clientid, StringDatatype messageBody, Data extraData) {
/* 29 */     this.clientid = clientid;
/* 30 */     this.messageBody = messageBody;
/* 31 */     this.extraData = extraData;
/*    */   }
/*    */   
/*    */   public MessageVicinity(ByteBuffer byteBuffer) {
/* 35 */     this.clientid = new Integer32(byteBuffer, Endianess.BIG_ENDIAN);
...
/* 47 */     return new MessageVicinity(buffer);
/*    */   }
/*    */ 
/*    */   
/*    */   public int getSerializedSize() {
/* 52 */     return this.clientid.getSizeInBytes() + this.messageBody.getSizeInBytes() + this.extraData.getSizeInBytes();
/*    */   }
/*    */ 
/*    */ 
/*    */ 
...
/* 59 */     this.clientid.toByteBuffer(buffer);
...
/* Location:              C:\Users\ryand\Desktop\PVM Revival\pvm-game-decomp\tcg-gameengine.jar!\com\funcom\gameengine\conanchat\packets2\MessageVicinity.class
