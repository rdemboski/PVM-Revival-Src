...
/*    */ 
/*    */ 
/*    */ public class TelnetRefreshProcessor
/*    */   extends TelnetCommandProcessor
/*    */ {
/*    */   public TelnetRefreshProcessor(String[] message, SelectionKey selectedKey, TelnetCommandsExecutor serverCommandQueue, Logger LOGGER) {
...
/* 25 */       this.LOGGER.debug("Refresh player requested, ID: " + this.message[1]);
/* 26 */       this.serverCommandQueue.refreshRequest(id);
...
/* Location:              C:\Users\ryand\Desktop\PVM Revival\pvm-game-decomp\tcg-gameengine.jar!\com\funcom\gameengine\sshshell\processors\TelnetRefreshProcessor.class
