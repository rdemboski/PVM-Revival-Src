...
/*    */ 
/*    */ 
/*    */ public class TelnetSaveProcessor
/*    */   extends TelnetCommandProcessor
/*    */ {
/*    */   public TelnetSaveProcessor(String[] message, SelectionKey selectedKey, TelnetCommandsExecutor serverCommandQueue, Logger LOGGER) {
...
/* 25 */       this.LOGGER.debug("Save player requested, ID: " + this.message[1]);
/* 26 */       this.serverCommandQueue.forceSaveRequest(id);
...
/* Location:              C:\Users\ryand\Desktop\PVM Revival\pvm-game-decomp\tcg-gameengine.jar!\com\funcom\gameengine\sshshell\processors\TelnetSaveProcessor.class
