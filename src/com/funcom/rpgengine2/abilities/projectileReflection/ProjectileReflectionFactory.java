...
/*    */ 
/*    */ 
/*    */ public class ProjectileReflectionFactory
...
/* 24 */     return (Ability)new ProjectileReflectionCreator(params, loader);
/*    */   }
/*    */ 
/*    */   
/*    */   public AbilityParams createParams(List<String[]> fieldsList) {
/* 29 */     AbilityParams params = new AbilityParams();
/* 30 */     params.setRecords(fieldsList, new AbilityParams.ParamName[] { AbilityParams.ParamName.ID, AbilityParams.ParamName.REFLECTION_VALUE, AbilityParams.ParamName.SHAPE_REF, AbilityParams.ParamName.DFX_REFERENCE });
/* 31 */     return params;
/*    */   }
/*    */ }


/* Location:              C:\Users\ryand\Desktop\PVM Revival\pvm-game-decomp\tcg-rpgengine.jar!\com\funcom\rpgengine2\abilities\projectileReflection\ProjectileReflectionFactory.class
