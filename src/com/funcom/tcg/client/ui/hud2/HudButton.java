...
/*    */   
/*    */   public HudButton(String text, String tooltipText, TCGToolTipManager tooltipManager, ResourceManager resourceManager) {
/* 16 */     super(text);
...
/* 24 */     return this.tooltipManager.getHudHtml(this.tooltipText);
/*    */   }
/*    */ 
/*    */   
/*    */   protected BComponent createTooltipComponent(String tiptext) {
/* 29 */     return (BComponent)new HTMLView2(tiptext, this.resourceManager);
/*    */   }
/*    */ }


/* Location:              C:\Users\ryand\Desktop\PVM Revival\pvm-game-decomp\tcg-client.jar!\com\funcom\tcg\clien\\ui\hud2\HudButton.class
